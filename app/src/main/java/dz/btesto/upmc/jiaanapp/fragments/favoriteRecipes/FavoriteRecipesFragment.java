...
import static dz.btesto.upmc.jiaanapp.activities.recipesDetails.RecipesDetails.FAVORITE_RECIPES_COLUMN;
...
public class FavoriteRecipesFragment extends Fragment {
    ...
    private ArrayList<Recipe> mAdapterItems;
    ...
    private void setupFireBase() {
        ...
        mQuery = rootRef
                .child(FAVORITE_RECIPES_COLUMN)
                .child(userID);

    }

    private void setupRecyclerView() {
        RecyclerView recyclerView = (RecyclerView) rootView.findViewById(R.id.categorie_recyclerview);
        favoriteRecipesAdapter = new FavoriteRecipesAdapter(getContext(), mQuery, Recipe.class, mAdapterItems, mAdapterKeys);
